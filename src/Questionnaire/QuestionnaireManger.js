...
class QuestionnaireManger extends Component {
    ...
    async presentQuestionnaire(){
        if(sessionStorage.getItem('patient')) {
            let url = '  https://modamedic.cs.bgu.ac.il/auth/usersAll/getUserQuestionnaire';
    ...
    handleSubmit(e){
        ...
        //     axios.post('  https://modamedic.cs.bgu.ac.il/auth/usersAll/changeDateOfSurgery',
        //         {
        //             UserID: id,
        //             DateOfSurgery: date
        //         },
    ...
    handleSubmitQ(e){
        ...
        if(sessionStorage.getItem('doctor')) {
            ...
            let id = this.props.user["UserID"];
            axios.post('  https://modamedic.cs.bgu.ac.il/auth/usersAll/changeUserQuestionnaire',
                {
                    UserID: id,
