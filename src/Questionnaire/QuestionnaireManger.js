...
class QuestionnaireManger extends Component {
    ...
    async presentQuestionnaire(){
        if(sessionStorage.getItem('patient')) {
            let url = '  https://rps.ise.bgu.ac.il/njsw18auth/usersAll/getUserQuestionnaire';
    ...
    handleSubmit(e){
        ...
        //     axios.post('  https://rps.ise.bgu.ac.il/njsw18auth/usersAll/changeDateOfSurgery',
        //         {
        //             UserID: id,
        //             DateOfSurgery: date
        //         },
    ...
    handleSubmitQ(e){
        ...
        if(sessionStorage.getItem('doctor')) {
            ...
            let id = this.props.user["UserID"];
            axios.post('  https://rps.ise.bgu.ac.il/njsw18auth/usersAll/changeUserQuestionnaire',
                {
                    UserID: id,
