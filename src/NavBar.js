...
class NavBar extends React.Component {
    ...
    async handleSubmit(event){
        ...
        if(this.state.pass !== this.state.pass2){
            ...
            let url = '  https://modamedic.cs.bgu.ac.il/auth/usersAll/askChangePassword';
            var token;
            ...
            url = '  https://modamedic.cs.bgu.ac.il/users/passwordChangeCheck/changePassword';
    ...
    async getInfo(){
        let url = '  https://modamedic.cs.bgu.ac.il/auth/usersAll/userInfo';
        var token;
...
class DoctorInfo extends React.Component{
    ...
    async handleSubmitInfo(event) {
        ...
        const response = await axios.put('  https://modamedic.cs.bgu.ac.il/auth/usersAll/doctorUpdate', {
...
class UserInfo extends React.Component {
    ...
    async handleSubmitInfo(event) {
        ...
        let height_double = Number(this.state.height / 100);
        let bmi = String((Number(this.state.weight)/Math.pow(height_double,2)));
        const response = await axios.put('  https://modamedic.cs.bgu.ac.il/auth/usersAll/patientUpdate', {
                // UserID: this.state.userName,
                First_Name: this.state.fName,
                Last_Name: this.state.lName,
                Phone_Number: this.state.phone,
